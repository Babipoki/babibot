...
async def on_message(message):
    ...
    if (message.content.startswith('!newnickname') or message.content.startswith('!nn')):
        nicknames1 = ["Cockflipper", "Succotash", "Fucking", "Derpy", "Alcoholic", "Intolerant", "Appealing", "Indonesian", "Seaside", "Thrifty", "Unenjoyable", "Stupid", "Naked", "Orchestrated", "Unidentified", "Stupid", "Unused", "Untitled", "Boring", "Cricketsniffing", "Disposable", "Deplorable", "Soviet", "Triggered", "Republican", "Cute", "Limitless", "Sobbing", "Durable", "Cuckblaster", "Paragon of", "Cute", "Adorable", "Ugly", "Swift", "Attractive", "Bald", "Beautiful", "Chubby", "Clean", "Dazzling", "Elegant", "Fancy", "Fit", "Flabby", "Glamorous", "Gorgeous", "Handsome", "Magnificent", "Muscular", "Plain", "Plump", "Scruffy", "Shapely", "Skinny", "Unkempt", "Unsightly", "Agreeable", "Ambitious", "Brave", "Calm", "Delightful", "Eager", "Faithful", "Gentle", "Happy", "Jolly", "Kind", "Lively", "Nice", "Obedient", "Polite", "Proud", "Silly", "Thankful", "Victorious", "Witty", "Wonderful", "Zealous", "Angry", "Bewildered", "Clumsy", "Defeated", "Embarassed", "Fierce", "Grumpy", "Helpless", "Itchy", "Jealous", "Lazy", "Mysterious", "Nervous", "Obnoxious", "Panicky", "Pitiful", "Repulsive", "Scary", "Thoughtless", "Uptight", "Worried", "Big", "Colossal", "Fat", "Gigantic", "Great", "Huge", "Immense", "Large", "Little", "Massive", "Petite", "Puny", "Scrawny", "Short", "Small", "Tall", "Teeny", "Tiny", "Cringy", "Rotten", "Blood Moon", "Astro", "Fucky", "Galaxy", "Crime City", "Dragon Trainer", "Cosmic", "Cowgirl", "Omega Squad", "Praetorian", "Pajama", "The", "Final Boss", "Revolver", "Zombie", "Undead", "Incorporeal", "Captain", "Black", "Definitely Not", "Frozen", "Gothic", "Infernal", "El", "Origami", "Inflatable", "Super", "Headless", "Ceaseless", "Stray", "Asylum", "Crossbreed", "Demon", "Pinned", "The Bed of", "Bloodstained", "Thicc", "Thick", "Momma's"]
        nicknames2 = ["Charmander", "Bumbaloo", "Crocodile Hunter", "Puppy", "Radio Show Host", "Echidna", "Nut", "Dick", "Palm Tree", "Gangster", "Balloon", "Condomface", "Whippersnapper", "FUUUUUUUUUCK", "NPC", "side-quest NPC", "Lifeguard", "Donut", "Officer of Justice", "Buttsniffer", "Tree Branch", "Bunny Balloon", "Door Frame", "Screwdriver", "Mouse Balloon", "Cockroach", "Gorilla", "Sandshrew", "Scorbunny", "Pikachu", "Sobble", "Cucumber", "Bean", "Potato", "Tomato", "Onion", "Broccoli", "Brussels Sprout", "Fennel", "Herb", "Basil", "Marjoram", "Chamomile", "Sage", "Thyme", "Coriander", "Lettuce", "Cabbage", "Garlic", "Paprika", "Leek", "Beetroot", "Carrot", "Ginger", "Turnip", "Spinach", "Squash", "Sweetcorn", "Corn", "Apple", "Pear", "Orange", "Grapefruit", "Mandarin", "Lime", "Nectarine", "Apricot", "Peach", "Plum", "Banana", "Mango", "Strawberry", "Raspberry", "Blueberry", "Kiwifruit", "Passionfruit", "Watermelon", "Rockmelon", "Honeydew Melon", "Zucchini", "Cringe", "Minecrafter", "Minecraft Steve", "Astronaut", "Boy", "Sucky", "Phantom", "Churro", "Raboot", "Rat", "Mouse", "Horse", "Tiger", "Pool Toy", "Discharge", "Demon", "Anbu", "Assassin", "Grandpa", "Grandma", "Mom", "Dad", "Teemo", "Gnar", "Joke", "FFFFFFFFFFFart", "Fart", "Poop", "Fard & Shid", "Shidster n Fardster", "Lara Croft", "Tomb Raider"]
        oneWordNicknames = ["Dorito", "Rex", "Ahhhhhhhhhh", "?XD", "Ponies :D", "♥ Anal ♥", "♥ S E B A S T I A N ♥", "fucking" + randomString(random.randint(2, 10)), "xXxUnTiTlEdAnGeLxXx", "PUSSY!!!!!!!!", "Belend", "UNLICENSED ASS KICKER/KISSER", "Wuwu & Nillump", "actually belend", "fart XDDDDDDDDDDDDDDDDDD", "xXxUnfisted FisterxXx", 'xXxXgLoRiOuSpRiNcEoFdArKnEsSXxXx', "Sexmaster Extraordinaire", "Fucky Sucky", "Gender Gap", "D R A G O N  O F  J U S T I C E", "Rusty", "Hound", "Bingo", "Fksake m8", "Bajingas", ":D:D:D", ":(:(:(", "♥♥♥", "ROTTEN_GOBLIN.EXE", "haha fart sound funny :D", "Bfkendiket", "Fkendiket"]
        insults = ["sucker", "boomer", "asshole", "cuck", "pipsqueak", "dickwad", "edgelord", "Mr Crangis McBasketball", "cringelord", "dickhead", "the great emperor and producer of farts", "please love me", "idiod", "go back to playing league of legends", "do you like it? I think it's a pretty cool name, it fits how stupid you fucking are", "lol"]
        nickname = ""
        if random.randint(0, 5) == 1:
            nickname = random.choice(oneWordNicknames)
        elif random.randint(0, 4) == 3:
            nickname = random.choice(nicknames1).upper() + ' ' + random.choice(nicknames2).upper()
        elif random.randint(0, 3) == 2:
            nickname = random.choice(nicknames1).lower() + ' ' + random.choice(nicknames2).lower()
        else:
